...
describe('sync', () => {
    describe('folder', () => {
        ...
        it('createFolder when folder no exist', () => {
            createFolder(path.join(__dirname, 'folder1', 'folder2'))
        });
        it('createFolder when folder exist', () => {
            createFolder(path.join(__dirname, 'formats'))
        });
        ...
        it('existFolder', () => {
            ...
            expect(existFolder(path.join(__dirname, 'noexist'))).toEqual(false)
        });
        it('updateFolder', () => {
            createFolder(path.join(__dirname, 'old'))
            expect(updateFolder({ where: path.join(__dirname, 'old'), name: path.join(__dirname, 'new') })).toEqual(void 0)
            expect(() => updateFolder({ where: path.join(__dirname, 'old1'), name: path.join(__dirname, 'new') })).toThrow()
        });
        it('deleteFolder', () => {
            createFolder(path.join(__dirname, 'delete'))
            expect(deleteFolder(path.join(__dirname, 'delete'))).toEqual(void 0)
            expect(() => deleteFolder(path.join(__dirname, 'noexist'))).toThrow()
            expect(() => deleteFolder(path.join(__dirname, 'deleteFiles'))).toThrow()
        });
        it('deleteFolder', () => {
            createFolder(path.join(__dirname, 'delete'))
            expect(clearFolder(path.join(__dirname, 'delete'))).toEqual(void 0)
            expect(clearFolder(path.join(__dirname, 'noexist'))).toEqual(void 0)
            expect(clearFolder(path.join(__dirname, 'deleteFiles'))).toEqual(void 0)
        });
        it('folders', () => {
    ...
    describe('file', () => {
        ...
        it('createFile deleteFile', () => {
            ...
            const c = createFile({ path: path.join(root, 'a.stream.txt'), data: reader })
            ...
            expect(deleteFile(path.join(root, 'a.stream.txt'))).toEqual(void 0)
        });
